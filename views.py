...
def price_prediction(df):
    try:
        final_pipe=pickle.load(open("C:/Users/SHIVANK/OneDrive/Desktop/projects/project_ACPP/Web_App_Car_Price_Prediction_-master/jupyter-notebook/final_pipe.sav", 'rb'))
